...
class ViewController: UIViewController,
  ...
  @IBAction func didRotateKart(_ sender: UIRotationGestureRecognizer) {
    ...
    // Tip: Use the `rotate` function below
      ...
      //  I put a red box around Mario to make him easier to rotate
      // BUT IT STILL IS SO HARD :(
  }
  ...
  private func raceKartsWithSameSpeed() {
    // YOUR CODE HERE
      translate(kart: self.kartView0, by: view.frame.width, animationDuration: 0.2)
      translate(kart: self.kartView1, by: view.frame.width, animationDuration: 0.2)
      translate(kart: self.kartView2, by: view.frame.width, animationDuration: 0.2)
  }
